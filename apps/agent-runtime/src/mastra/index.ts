...
const [orchestratorTools, poTools, baTools, architectTools, devTools] = await Promise.all([
...
export const mastra = new Mastra({
  ...
  agents: { orchestrator, po: poAgent, ba: baAgent, architect: architectAgent, dev: devAgent },
