...
4. Sandbox isolation: Docker-in-CI vs Firecracker/gVisor for Dev-agent code. The stack the Dev agent will scaffold into that sandbox (frontend/backend/database, and how each is generated) is decided in `docs/adr/0001-dev-agent-scaffold-and-template-strategy.md`; this sandbox choice is still open.
